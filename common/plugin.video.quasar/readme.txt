...
The versions in Gaia's repo are a copy of the All-In-One package with the following changes:
  ...
  3. In "addon.xml" the Quasar addon version was changed for each OS.
